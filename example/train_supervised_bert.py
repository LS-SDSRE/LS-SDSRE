...
parser.add_argument('--pretrain_path', default='bert-large-uncased',
        help='Pre-trained ckpt path / model name (hugginface)')
parser.add_argument('--ckpt', default='', 
        help='Checkpoint name')
parser.add_argument('--pre_ckpt', default='',
        help='Checkpoint name')
...
parser.add_argument('--dataset', default='none', choices=['none', 'semeval', 'wiki80', 'tacred', 'nyt10m', 'kbp'],
...
parser.add_argument('--test_file', default='', type=str,
        help='Test data file')
parser.add_argument('--relation_file', default='', type=str,
        help='Test data file')
...
parser.add_argument('--pretrain_epoch', default=3, type=int,
        help='Max number of pretraining epochs')
...
if len(args.pre_ckpt) == 0:
    args.pre_ckpt = "without_neg_pre"+'{}_{}_{}'.format(args.dataset, args.pretrain_path, args.pooler)
ckpt = 'ckpt/{}.pth.tar'.format(args.ckpt)
pre_ckpt = 'ckpt/{}.pth.tar'.format(args.pre_ckpt)
...
if args.dataset != 'none':
    ...
    args.relation_file = os.path.join(root_path, 'benchmark', args.dataset, '{}_relation.txt'.format(args.dataset))
...
# Test
framework.load_state_dict(torch.load(pre_ckpt)['state_dict'])
result = framework.eval_model_np(framework.test_loader)
# framework.get_embeddings__()
